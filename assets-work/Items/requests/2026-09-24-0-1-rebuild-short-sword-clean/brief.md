# Item request 2026-09-24-0-1-rebuild-short-sword-clean

Rebuild Short Sword as a clean low-poly model

| | |
|---|---|
| Kind | redesign |
| Priority | normal |
| Status | open, filed 2026-09-24T17:40:14+02:00 from the item editor |
| Base commit | `7d516e7aafb10fc27022bba0bb2c0fe2607c73b3` |
| Branch | `codex/item-req-0-1-rebuild-short-sword-clean` |
| Deliver to | `assets-work/Items/requests/2026-09-24-0-1-rebuild-short-sword-clean/delivery/` |
| Push allowed | no |
...
`python3 assets-work/Items/requests/validate_request.py assets-work/Items/requests/2026-09-24-0-1-rebuild-short-sword-clean`.
...
- Start from the reference mesh /Users/lukasmac/Documents/claude-test-mumain/item-sources/0-1/0-1-short-sword.glb (outside the repository; never copy it into the repo): it shows the wanted look
- Reduce it in Blender to at most 1500 triangles per model (Decimate, then clean up), keeping the silhouette
- Bake its colour and detail onto one diffuse texture: 512 px for small items, at most 1024 px
...
In-client captures of the current look without the editor, client commit `7d516e7a`.
