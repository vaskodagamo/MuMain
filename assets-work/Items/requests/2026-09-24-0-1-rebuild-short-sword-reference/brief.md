# Item request 2026-09-24-0-1-rebuild-short-sword-reference

Rebuild Short Sword from the reference mesh

| | |
|---|---|
| Kind | redesign |
| Priority | normal |
| Status | open, filed 2026-09-24T16:05:33+02:00 from the item editor |
| Base commit | `08658c6c9d57a9187631643a521badbc2f4e7c78` |
| Branch | `codex/item-req-0-1-rebuild-short-sword-reference` |
| Deliver to | `assets-work/Items/requests/2026-09-24-0-1-rebuild-short-sword-reference/delivery/` |
| Push allowed | no |
...
`python3 assets-work/Items/requests/validate_request.py assets-work/Items/requests/2026-09-24-0-1-rebuild-short-sword-reference`.
...
- Start from the reference mesh /Users/lukasmac/Documents/claude-test-mumain/item-sources/0-1-short-sword.glb (50000 triangles, 3 textures); it matches the picked concept
- Reduce it in Blender to at most 1500 triangles (Decimate, then clean up), keeping the silhouette
- Bake its colour and detail onto one 512 x 512 diffuse texture
- Match the original Sword02.bmd: grip at the model origin, same length, same orientation
...
In-client captures of the current look without the editor, client commit `08658c6c`.
