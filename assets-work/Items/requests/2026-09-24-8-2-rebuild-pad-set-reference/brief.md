# Item request 2026-09-24-8-2-rebuild-pad-set-reference

Rebuild Pad set from the reference mesh

| | |
|---|---|
| Kind | set (redesign for every part) |
| Priority | normal |
| Status | open, filed 2026-09-24T20:55:27+02:00 from the item editor |
| Base commit | `e566aaa9625c7d348bb0fef329d6dfb732b5dca5` |
| Branch | `codex/item-req-8-2-rebuild-pad-set-reference` |
| Deliver to | `assets-work/Items/requests/2026-09-24-8-2-rebuild-pad-set-reference/delivery/` |
| Push allowed | no |
...
`python3 assets-work/Items/requests/validate_request.py assets-work/Items/requests/2026-09-24-8-2-rebuild-pad-set-reference`.
...
In-client captures of the current look without the editor, client commit `e566aaa9`.
