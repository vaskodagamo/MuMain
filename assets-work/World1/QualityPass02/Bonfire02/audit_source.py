...
def check(folder):
    ...
    (folder / 'validation/authored-triangle-match.json').write_text(json.dumps(dict(
        ...
        precision='Six-decimal SMD Euler roundtrip and float32 coordinates: measured matrix delta 4.733e-7 over a 320-unit asset; bounded 0.0003 world-unit budget'), indent=2))
