...
spec=importlib.util.spec_from_file_location('raw',ROOT.parents[1]/'Architecture03/raw_bindings.py')
...
if __name__=='__main__':
    for name in ('Well01','Well02','Well03','Well04'):print(name,check(ROOT/name,'baseline'))
