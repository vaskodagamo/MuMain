...
def build():
 ...
 (folder/'validation/authored.json').write_text(json.dumps(dict(triangles=len(output),bounds_before=before,bounds_after=after,protected_original_triangle_indices=protected,geometry_stage_only=True),indent=2)+'\n')
