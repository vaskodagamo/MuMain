"""Compare actual authored corner normals to raw final BMD through all40 keys."""
import json
...
def audit():
    ...
    raw_triangles=[(mesh,vertices,normals) for mesh in raw.meshes(folder/'exports/House04.bmd') for vertices,normals in mesh['triangles']]
