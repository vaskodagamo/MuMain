...
SELECTIONS={
 'House01-0':('House01',0,480,('Stair01','Sign01','StoneMuWall02','StoneMuWall03')),
 'House01-1':('House01',1,480,('Grass01','Straw01','StoneMuWall02','StoneMuWall03')),
 'House03-0':('House03',0,450,('House02','HouseEtc01','TreasureDrum01','Light03')),
 'House04-0':('House04',0,400,('Sign01','Fence03','SteelWall02','SteelWall03','StoneMuWall02','StoneMuWall03','HouseEtc03'))}
...
if __name__=='__main__':
    ...
    for label,(name,index,radius,allowed) in SELECTIONS.items():
        ...
        for other in allowed:
            for i,record in enumerate(MAP[other]['placements']):
