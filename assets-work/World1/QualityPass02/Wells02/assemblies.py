...
if __name__=='__main__':
    group('well-and-pots',[placement('Well02',0),placement('Well03',0)])
    group('eastern-pots',[placement('Well03',1)],True)
    group('west-vessels',[placement('Well04',0)],True)
    group('north-vessels',[placement('Well04',1)],True)
