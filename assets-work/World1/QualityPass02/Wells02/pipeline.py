"""Official Blender/BMD interchange and strict well/pottery contract audits."""
...
NAMES=tuple(sys.argv[2:]) if len(sys.argv)>2 else ('Well03','Well04','Well02','Well01')
...
def main():
    if sys.argv[1]=='prepare':
        for name in ('Well01','Well02','Well03','Well04'):import_model(ROOT/name,'baseline')
        return
    ...
    helper('composite_parts',ROOT/'audit_composite.py').main()
    helper('protected_contacts',ROOT/'audit_contacts.py').check()
