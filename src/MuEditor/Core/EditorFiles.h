...
// File helpers shared by the editors' save paths (Map Editor, Item Editor).
...
// legacy backslash strings; they resolve those themselves. The map folders are in
// UI/MapEditor/MapEditorFileUtil.h.
...
struct SavedFile
{
    ...
    MirrorOutcome repo;                // the copy in <repo>/src/bin/Data (see RepoMirror.h)
...
// Call right after writing `dataRelative` (built from DataDir(), e.g.
// Data/World1/EncTerrain1.obj or Data/Local/Eng/Item_Eng.bmd). Copies the file into <repo>/src/bin/Data,
